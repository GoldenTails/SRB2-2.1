...
static menuitem_t OP_MainMenu[] =
{
	...
	{IT_STRING  | IT_CALL,   NULL, "Add-on Options...",     M_AddonsOptions,      70},
};
...
static void M_Options(INT32 choice)
{
	...
	OP_MainMenu[4].status = (Playing() && !(server || IsPlayerAdmin(consoleplayer))) ? (IT_GRAYEDOUT) : (IT_STRING|IT_SUBMENU);
